<?php
    ...
    // Načítá pole z formuláře - name, email a message; odstraňuje bílé znaky;
    ...
    if (empty($name) OR empty($message) OR !filter_var($email, FILTER_VALIDATE_EMAIL)) {
        header("Location: http://www.richardskoda.eu/index.php?success=-1#form");
        exit;
    }

    // Nastavte si email, nakterý chcete, aby se vyplněný formulář odeslal - jakýkoli váš email
    $recipient = "richard.skoda72@gmail.com";
